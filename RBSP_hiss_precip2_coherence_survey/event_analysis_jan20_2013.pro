...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-20'
  tplot_options,'title','event_analysis_jan20_2013.pro'
  pre = '1'
...
fn = 'DH_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DI_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DK_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DQ_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
fn = 'HK_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
fn = 'KQ_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
pp = '/Users/aaronbreneman/Desktop/Research/RBSP_hiss_precip2_coherence_survey/Analysis_major_events_campaign1/Jan20/'

tplot_restore,filenames=pp+'lanl_sat_1991-080_20130120.tplot'
tplot_restore,filenames=pp+'lanl_sat_1994-084_20130120.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-01A_20130120.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-02A_20130120.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-04A_20130120.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-97A_20130120.tplot'
...
t0tmp = time_double('2013-01-20/00:00')
t1tmp = time_double('2013-01-20/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_1G_smoothed_detrend','fspc_1C_smoothed_detrend','coh_GC_meanfilter'],/add




;tplot,['omni_Np','omni_elect_density']+'_smoothed_detrend'
;tplot,['fspc_1G_smoothed_detrend','fspc_1C_smoothed_detrend','omni_press_dyn_smoothed']

tplot,['omni_press_dyn_smoothed']
...
plot_dial_payload_location_specific_time,'2013-01-20/08:00'
plot_dial_payload_location_specific_time,'2013-01-20/16:00'
