...
;also see Jan9_event.ppt

;pro event_analysis_jan9
  rbsp_efw_init
  tplot_options,'title','event_analysis_jan9.pro'
...
;timespan,'2014-01-09/15:00',9,/hours
...
store_data,'fspc_IT_comb',data=['fspc_2I_smoothed_detrend','fspc_2T_smoothed_detrend']
options,'fspc_IT_comb','colors',[0,250]
tplot,'fspc_IT_comb'
...
t0tmp = time_double('2014-01-09/00:00')
t1tmp = time_double('2014-01-10/00:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp
tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','coh_allcombos_meanfilter_normalized2_OMNI_press_dyn','fspc_2K_smoothed_detrend','fspc_2L_smoothed_detrend','coh_KL_meanfilter'],/add
...
cdf2tplot,ptmp+'tha_l2_efi_20140109_v01.cdf'
cdf2tplot,ptmp+'tha_l2_fgm_20140109_v01.cdf'
cdf2tplot,ptmp+'tha_l2_mom_20140109_v01.cdf'
cdf2tplot,ptmp+'thb_l2_efi_20140109_v01.cdf'
cdf2tplot,ptmp+'thb_l2_fgm_20140109_v01.cdf'
cdf2tplot,ptmp+'thb_l2_mom_20140109_v01.cdf'
cdf2tplot,ptmp+'thc_l2_efi_20140109_v01.cdf'
cdf2tplot,ptmp+'thc_l2_fgm_20140109_v01.cdf'
cdf2tplot,ptmp+'thc_l2_mom_20140109_v01.cdf'
cdf2tplot,ptmp+'thd_l2_efi_20140109_v01.cdf'
cdf2tplot,ptmp+'thd_l2_fgm_20140109_v01.cdf'
cdf2tplot,ptmp+'thd_l2_mom_20140109_v01.cdf'
cdf2tplot,ptmp+'the_l2_efi_20140109_v01.cdf'
cdf2tplot,ptmp+'the_l2_fgm_20140109_v01.cdf'
cdf2tplot,ptmp+'the_l2_mom_20140109_v01.cdf'
...
plot_dial_payload_location_specific_time,'2014-01-09/17:00'
plot_dial_payload_location_specific_time,'2014-01-09/20:10'
...
t0tmp = time_double('2014-01-09/21:00')
t1tmp = time_double('2014-01-09/22:00')
