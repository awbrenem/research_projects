...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-27'
  tplot_options,'title','event_analysis_jan27_2013.pro'
  pre = '1'
...
fn = 'GU_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
fn = 'SU_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
t0tmp = time_double('2013-01-27/00:00')
t1tmp = time_double('2013-01-27/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_1H_smoothed_detrend','fspc_1Q_smoothed_detrend','coh_HQ_meanfilter'],/add
...
plot_dial_payload_location_specific_time,'2013-01-27/15:00'
plot_dial_payload_location_specific_time,'2013-01-27/20:00'
...
;^^Wind Bmag comparison (looking for 5min waves)
rbsp_detrend,'fspc_'+pre+'?',2.*60.
rbsp_detrend,'fspc_'+pre+'?_smoothed',80.*60.
rbsp_detrend,'wi_h0_mfi_bmag',1*60.
rbsp_detrend,'wi_h0_mfi_bmag_smoothed',80*60.
tplot,['fspc_1?','wi_h0_mfi_bmag_smoothed_detrend']


;^^Wind to OMNI comparison 
tplot,['wi_h0_mfi_bmag_smoothed_detrend','OMNI_HRO_1min_Bmag']
