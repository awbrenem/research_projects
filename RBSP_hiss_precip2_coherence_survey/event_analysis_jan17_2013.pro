...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-17'
  tplot_options,'title','event_analysis_jan17_2013.pro'
  pre = '1'
...
t0tmp = time_double('2013-01-17/00:00')
t1tmp = time_double('2013-01-17/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


ylim,'fspc_1G_smoothed_detrend',-10,10
tplot,['kyoto_ae','kyoto_dst','coh_allcombos_meanfilter_normalized2','fspc_1G_smoothed_detrend','fspc_1C_smoothed_detrend','coh_GC_meanfilter'],/add
...
plot_dial_payload_location_specific_time,'2013-01-17/10:30'
plot_dial_payload_location_specific_time,'2013-01-17/14:00'
