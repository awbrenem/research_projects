...
;Calculate MLT
  ...
  store_data,'firebird_mlt',data={x:pos_gse_fb.x,y:angle_rad}
...
tplot_save,'*',filename='~/Desktop/Research/RBSP_Firebird_microburst_conjunction_jan20/IDL/aaron_fb4_rbspa'    ;don't add .tplot
