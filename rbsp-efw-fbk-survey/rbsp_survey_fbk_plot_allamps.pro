...
pro rbsp_survey_fbk_plot_allamps,$
   info,$
   values,$
   counts,$
...
;;Set amplitude titles

;*****
;need to change for avg values
  amptitles = info.amp_bins_pk
;
;*****

  at0 = amptitles
  at1 = shift(amptitles,1)
