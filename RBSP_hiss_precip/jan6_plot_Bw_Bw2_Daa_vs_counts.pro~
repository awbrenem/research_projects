...
tinterpol_mxn,'PeakDet_2K','Bfield_hissinta'
tinterpol_mxn,'rbspa_state_mlt','Bfield_hissinta'
tinterpol_mxn,'rbspa_state_lshell','Bfield_hissinta'
tinterpol_mxn,'MLT_Kp2_T89c_2K','Bfield_hissinta'
tinterpol_mxn,'L_Kp2_2K','Bfield_hissinta'


get_data,'rbspa_state_mlt_interp',data=mlt_a
get_data,'rbspa_state_lshell_interp',data=lshell_a
get_data,'MLT_Kp2_T89c_2K_interp',data=mlt_2k
get_data,'L_Kp2_2K_interp',data=lshell_2k

t1z = (mlt_a.y - 12)*360./24.
t2z = (mlt_2K.y - 12)*360./24.
x1 = lshell_a.y * sin(t1z*!dtor)
y1 = lshell_a.y * cos(t1z*!dtor)
x2 = lshell_2K.y * sin(t2z*!dtor)
y2 = lshell_2K.y * cos(t2z*!dtor)
...
tplot,['2K_avebounce','2K_avebounce50','2K_avebouncetots']
...
tinterpol_mxn,'2K_avebouncetots','PeakDet_2K_interp'
...
x = tsample('2K_avebounce50_interp',time_double([t0,t1]),times=tms)
store_data,'Daa',data={x:tms,y:x}
x = tsample('2K_avebouncetots_interp',time_double([t0,t1]),times=tms)
store_data,'DaaT',data={x:tms,y:x}
x = tsample('PeakDet_2K_interp',time_double([t0,t1]),times=tms)
store_data,'PeakDet_2K',data={x:tms,y:x}
x = tsample('Bfield_hissinta',time_double([t0,t1]),times=tms)
store_data,'Bfield_hissinta',data={x:tms,y:x}

tplot,['Daa','DaaT','PeakDet_2K','Bfield_hissinta']
...
plot,pk.y-3500.,daaT.y,psym=4,ytitle='<DaaT>',xtitle='PeakDet2K_counts',/ylog,yrange=[1d-8,1d-2],xrange=[0,1500]
...
plot,pk.y-3500.,daaT.y,psym=4,ytitle='<DaaT>',xtitle='PeakDet2K_counts',xrange=[0,1500],yrange=[0,0.0005]
...
tplot,['Bcomb','Bcomb2','2Kcomb']


tplot,['Bfield_hissinta_detrend','Bfield_hissinta2_detrend','PeakDet_2K_interp_detrend']
...
tplot,['PeakDet_2K_interp_detrend2','Bfield_hissinta_detrend','Bfield_hissinta2_detrend','Daa_detrend2','DaaT_detrend2']
...
plot,pk2.y,daaT2.y,psym=4,ytitle='<DaaT> fluctuations',xtitle='PeakDet2K_count fluctuations',xrange=[0,1000],yrange=[0,0.0003]
...
;store_data,'B2n',data={x:b22.x,y:b22.y/4200.}
...
tplot,['b1p','b2p','daapT','dak','mak','lak']
