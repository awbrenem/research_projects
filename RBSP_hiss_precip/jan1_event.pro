...
tplot_options,'title','from jan1_event1.pro'
...
t0 = time_double('2014-01-01/10:00')
t1 = time_double('2014-01-01/22:00')
...
;--------------------------------------------------
get_data,'PeakDet_2T',data=dd
goo = where(dd.y lt 0.)
if goo[0] ne -1 then dd.y[goo] = !values.f_nan
xv = dd.x
yv = dd.y
interp_gap,xv,yv
store_data,'PeakDet_2T',data={x:xv,y:yv}
options,'PeakDet_2T','colors',250
;--------------------------------------------------
...
dif_data,'L_Kp2_2I','L_Kp2_2T'  
dif_data,'MLT_Kp2_T89c_2T','MLT_Kp2_T89c_2I'  
copy_data,'MLT_Kp2_T89c_2T-MLT_Kp2_T89c_2I','delta_MLT_abs_IT'
copy_data,'L_Kp2_2I-L_Kp2_2T','delta_L_abs_IT'
options,'delta_MLT_abs_IT','ytitle','|delta-MLT|!C2I and 2T'
options,'delta_L_abs_IT','ytitle','|delta-L|!C2I and 2T'


dif_data,'L_Kp2_2W','L_Kp2_2T'  
dif_data,'MLT_Kp2_T89c_2W','MLT_Kp2_T89c_2T'  
copy_data,'MLT_Kp2_T89c_2W-MLT_Kp2_T89c_2T','delta_MLT_abs_WT'
copy_data,'L_Kp2_2W-L_Kp2_2T','delta_L_abs_WT'
options,'delta_MLT_abs_WT','ytitle','|delta-MLT|!C2W and 2T'
options,'delta_L_abs_WT','ytitle','|delta-L|!C2W and 2T'
...
copy_data,'PeakDet_2T_smoothed','PeakDet_2T_smoothed2'
...
copy_data,'PeakDet_2T_smoothed2_detrend','PeakDet_2T_detrend2'
...
ylim,'PeakDet_2W_smoothed2',3000,3400
ylim,'PeakDet_2T_smoothed2',3000,4000
ylim,'PeakDet_2I_smoothed2',3000,7000
ylim,'L_Kp2_2I',0,10
ylim,'L_Kp2_2K',0,6
ylim,'delta_MLT_abs_??',-10,10
ylim,'delta_L_abs_??',-10,10
tplot,['PeakDet_2W_smoothed2','PeakDet_2T_smoothed2','PeakDet_2I_smoothed2','delta_MLT_abs_??','delta_L_abs_??']
tplot,['PeakDet_2W_smoothed2','PeakDet_2T_smoothed2','PeakDet_2I_smoothed2','Bfield_hissint?2_smoothed']


tplot,['PeakDet_2W_smoothed2_detrend','PeakDet_2T_smoothed2_detrend','PeakDet_2I_smoothed2_detrend','Bfield_hissint?2_detrend']
