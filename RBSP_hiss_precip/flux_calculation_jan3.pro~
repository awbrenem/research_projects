...
;	df = 9d4   ;e-/cm2/s/sr/keV  (for 8 deg PA)
	df = 4d4   ;e-/cm2/s/sr/keV  (for 3 deg PA)
;        df = 2d4
...
;--------------------------------------------------
        ...
        print,nb2/nb ;=312  (should equal 1 if BARREL and MagEIS calculations agree)





;Best case scenario I still get nb2/nb = 50
;df = 2d4
;Bratio = 200
;nb = 500
