...
;-----------------------------------------------
rbsp_load_barrel_lc,'2W',date,type='rcnt'
...
;file = '/Users/aaronbreneman/Desktop/Research/RBSP_hiss_precip/barrel_cdfs/For_Aaron2014_01_06_200000.hdf5'
...
rbsp_detrend,'2K_avebounce30',60.*20.
rbsp_detrend,'2K_avebounce50',60.*20.
rbsp_detrend,'2K_avebounce75',60.*20.
rbsp_detrend,'2K_avebounce150',60.*20.
rbsp_detrend,'2K_avebouncetots',60.*20.
;local diffusion
rbsp_detrend,'2K_avelocal30',60.*20.
rbsp_detrend,'2K_avelocal50',60.*20.
rbsp_detrend,'2K_avelocal75',60.*20.
rbsp_detrend,'2K_avelocal150',60.*20.
rbsp_detrend,'2K_avelocaltots',60.*20.
...
tplot,['PeakDet_2K_sp_detrend_detrend','Bfield_hissinta_sp_detrend_detrend','densitya_sp_detrend_detrend','rbspa_emfisis_l3_1sec_mgse_Mag_sp_detrend_detrend_z','fesa30_sp_detrend_detrend','fesa54_sp_detrend_detrend','fesa80_sp_detrend_detrend','fesa108_sp_detrend_detrend','fesa144_sp_detrend_detrend']
tplot,['PeakDet_2K_sp_detrend_detrend','Bfield_hissinta_sp_detrend_detrend','densitya_sp_detrend_detrend','rbspa_emfisis_l3_1sec_mgse_Mag_sp_detrend_detrend_z','fesa30_sp_detrend_detrend','2K_avebounce30_detrend']



;Run cross-correlations

tinterpol_mxn,'Bfield_hissinta_sp_detrend_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'PeakDet_2W_sp_detrend_detrend','PeakDet_2K_sp_detrend_detrend'
...
tinterpol_mxn,'2K_avebounce30_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avebounce50_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avebounce75_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avebounce150_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avebouncetots_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avelocal30_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avelocal50_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avelocal75_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avelocal150_detrend','PeakDet_2K_sp_detrend_detrend'
tinterpol_mxn,'2K_avelocaltots_detrend','PeakDet_2K_sp_detrend_detrend'
...
tlimit,T1,T2
tplot,['PeakDet_2K_sp_detrend_detrend','Bfield_hissinta_sp_detrend_detrend',$
...
'fesa54_sp_detrend_detrend','fesa80_sp_detrend_detrend','2K_avebouncetots_detrend','2K_avelocaltots_detrend'];,'fesa108_sp_detrend_detrend','fesa144_sp_detrend_detrend']




Results1=cross_spec_tplot('PeakDet_2K_sp_detrend_detrend',0,'Bfield_hissinta_sp_detrend_detrend_interp',0,T1,T2,sub_interval=3,overlap_index=4)
...
Results7=cross_spec_tplot('PeakDet_2K_sp_detrend_detrend',0,'2K_avebounce30_detrend',0,T1,T2,sub_interval=3,overlap_index=4)
...
;NaN out coherence values below mincor2
mincor2 = 0.6
goo = where(results1[*,2] lt mincor2)  &  Results1[goo,2] = !values.f_nan
goo = where(results2[*,2] lt mincor2)  &  Results2[goo,2] = !values.f_nan
goo = where(results3[*,2] lt mincor2)  &  Results3[goo,2] = !values.f_nan
goo = where(results4[*,2] lt mincor2)  &  Results4[goo,2] = !values.f_nan
goo = where(results5[*,2] lt mincor2)  &  Results5[goo,2] = !values.f_nan
goo = where(results6[*,2] lt mincor2)  &  Results6[goo,2] = !values.f_nan
goo = where(results7[*,2] lt mincor2)  &  Results7[goo,2] = !values.f_nan
goo = where(results8[*,2] lt mincor2)  &  Results8[goo,2] = !values.f_nan
goo = where(results9[*,2] lt mincor2)  &  Results9[goo,2] = !values.f_nan
goo = where(results10[*,2] lt mincor2)  &  Results10[goo,2] = !values.f_nan
...
oplot,[0.0014,0.0014],[0,10d9],thick=2
oplot,[0.005,0.005],[0,10d9],thick=2
Plot,Results5[*,0],Results5[*,4],xtitle='f, Hz', ytitle='Power FESA30 (counts^2/Hz)',xrange=[0,0.01],yrange=[1d6,1d7],/ylog
oplot,[0.0014,0.0014],[1,10d9],thick=2
oplot,[0.005,0.005],[1,10d9],thick=2
...
!p.multi = [0,0,2]
Plot,Results1[*,0],Results1[*,2],xtitle='f, Hz', ytitle='Coherence_Ey_Ez',title=rbspx+time_rbsp,xrange=[0,0.015],yrange=[0.6,1],/nodata
oplot,[0.0014,0.0014],[0,1],thick=2
oplot,[0.005,0.005],[0,1],thick=2
oPlot,Results1[*,0],Results1[*,2],color=0	;precip and hiss  
oPlot,Results7[*,0],Results7[*,2],color=25 ;precip and bounce averaged diffusion at 30 keV
oPlot,Results2[*,0],Results2[*,2],color=50  ;precip and dens
oPlot,Results10[*,0],Results10[*,2],color=250  ;precip and BzGSE
...
!p.multi = [0,0,2]
Plot,Results1[*,0],Results1[*,2],xtitle='f, Hz', ytitle='Coherence_Ey_Ez',title=rbspx+time_rbsp,xrange=[0,0.01],yrange=[0.6,1],/nodata
oplot,[0.0014,0.0014],[0,1],thick=2
oplot,[0.005,0.005],[0,1],thick=2
oPlot,Results1[*,0],Results1[*,2],color=0	;precip and hiss  
oPlot,Results7[*,0],Results7[*,2],color=25 ;precip and bounce averaged diffusion at 30 keV
...
timebar,0.0014,varname='Precip_diffusiontots_coherence',/databar,thick=2
timebar,0.005,varname='Precip_diffusiontots_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_diffusiontots_phase',/databar,thick=2
timebar,0.005,varname='Precip_diffusiontots_phase',/databar,thick=2
...
get_data,'Precip2w_hiss_coherence',data=coh
get_data,'Precip2w_hiss_phase',data=ph
goo = where(coh.y le cormin)
if goo[0] ne -1 then coh.y[goo] = !values.f_nan
if goo[0] ne -1 then ph.y[goo] = !values.f_nan
boo = where(finite(coh.y) eq 0)
if boo[0] ne -1 then ph.y[boo] = !values.f_nan
store_data,'Precip2w_hiss_coherence',data=coh
store_data,'Precip2w_hiss_phase',data=ph
options,'Precip2w_hiss_coherence','ytitle','Precip2w vs hiss!CCoherence!Cfreq[Hz]'
options,'Precip2w_hiss_phase','ytitle','Precip2w vs hiss!CPhase!Cfreq[Hz]'
ylim,['Precip2w_hiss_coherence','Precip2w_hiss_phase'],-0.001,0.01
tplot,['Precip2w_hiss_coherence','Precip2w_hiss_phase',v1,v2]
timebar,0.0014,varname='Precip2w_hiss_coherence',/databar,thick=2
timebar,0.005,varname='Precip2w_hiss_coherence',/databar,thick=2
timebar,0.0014,varname='Precip2w_hiss_phase',/databar,thick=2
timebar,0.005,varname='Precip2w_hiss_phase',/databar,thick=2



v1 = 'PeakDet_2K_sp_detrend_detrend'
v2 = '2K_avebounce30_detrend_interp'
...
timebar,0.0014,varname='Precip_diffusion30_coherence',/databar,thick=2
timebar,0.005,varname='Precip_diffusion30_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_diffusion30_phase',/databar,thick=2
timebar,0.005,varname='Precip_diffusion30_phase',/databar,thick=2



v1 = 'PeakDet_2K_sp_detrend_detrend'
v2 = '2K_avebounce75_detrend_interp'
dynamic_cross_spec_tplot,v1,0,v2,0,T1,T2,window,lag,coherence_time,new_name='Precip_diffusion75'  
get_data,'Precip_diffusion75_coherence',data=coh
get_data,'Precip_diffusion75_phase',data=ph
goo = where(coh.y le cormin)
if goo[0] ne -1 then coh.y[goo] = !values.f_nan
if goo[0] ne -1 then ph.y[goo] = !values.f_nan
boo = where(finite(coh.y) eq 0)
if boo[0] ne -1 then ph.y[boo] = !values.f_nan
store_data,'Precip_diffusion75_coherence',data=coh
store_data,'Precip_diffusion75_phase',data=ph
options,'Precip_diffusion75_coherence','ytitle','Precip vs bounceaverageddiffusion75keV!CCoherence!Cfreq[Hz]'
options,'Precip_diffusion75_phase','ytitle','Precip vs bounceaverageddiffusion75keV!CPhase!Cfreq[Hz]'
ylim,['Precip_diffusion75_coherence','Precip_diffusion75_phase'],-0.001,0.01
tplot,['Precip_diffusion75_coherence','Precip_diffusion75_phase',v1,v2]
timebar,0.0014,varname='Precip_diffusion75_coherence',/databar,thick=2
timebar,0.005,varname='Precip_diffusion75_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_diffusion75_phase',/databar,thick=2
timebar,0.005,varname='Precip_diffusion75_phase',/databar,thick=2
...
timebar,0.0014,varname='Precip_fesa30_phase',/databar,thick=2
timebar,0.005,varname='Precip_fesa30_phase',/databar,thick=2


v2 = 'fesa54_sp_detrend_detrend_interp'
...
timebar,0.0014,varname='Precip_fesa54_coherence',/databar,thick=2
timebar,0.005,varname='Precip_fesa54_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_fesa54_phase',/databar,thick=2
timebar,0.005,varname='Precip_fesa54_phase',/databar,thick=2

v2 = 'fesa80_sp_detrend_detrend_interp'
...
timebar,0.0014,varname='Precip_fesa80_coherence',/databar,thick=2
timebar,0.005,varname='Precip_fesa80_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_fesa80_phase',/databar,thick=2
timebar,0.005,varname='Precip_fesa80_phase',/databar,thick=2


v2 = 'fesa108_sp_detrend_detrend_interp'
...
timebar,0.0014,varname='Precip_fesa108_coherence',/databar,thick=2
timebar,0.005,varname='Precip_fesa108_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_fesa108_phase',/databar,thick=2
timebar,0.005,varname='Precip_fesa108_phase',/databar,thick=2




zlim,'*_coherence*',0.6,1
tplot,['Precip_hiss_coherence','Precip_diffusiontots_coherence','Precip_dens_coherence','Precip_BzFA_coherence','Precip_BxFA_coherence','Precip_fesa30_coherence',v1]
timebar,0.0014,varname='Precip_hiss_coherence',/databar,thick=2
timebar,0.005,varname='Precip_hiss_coherence',/databar,thick=2
timebar,0.0014,varname='Precip_diffusiontots_coherence',/databar,thick=2
timebar,0.005,varname='Precip_diffusiontots_coherence',/databar,thick=2
...
timebar,0.0014,varname='hissa_hissb_coherence',/databar,thick=2
timebar,0.005,varname='hissa_hissb_coherence',/databar,thick=2
timebar,0.0014,varname='hissa_hissb_phase',/databar,thick=2
timebar,0.005,varname='hissa_hissb_phase',/databar,thick=2
...
;plot of sc separation vs total coherence for each time
;******
;Do this as a function of a single freq corresponding to 1 min period fluctuations
;******

;Reduce to times of interest
tt0 = time_double('2014-01-06/19:00')
tt1 = time_double('2014-01-06/23:00')
...
tplot,['dynamic_FFT_1','dynamic_FFT_2']
timebar,0.0014,varname='dynamic_FFT_1',/databar,thick=2
timebar,0.005,varname='dynamic_FFT_1',/databar,thick=2
timebar,0.0014,varname='dynamic_FFT_2',/databar,thick=2
timebar,0.005,varname='dynamic_FFT_2',/databar,thick=2
...
;jan6
!p.multi = [0,0,3]
;PLOT COHERENCE FOR SELECT FREQUENCIES ON JAN 6TH
...
;oplot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,3],psym=0 ;10 min
;oplot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,4],psym=4 ;7.5 min
;oplot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,5],psym=0 ;6 min
...
;oplot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,12],psym=0 ;2.5 min
...
get_data,'hissa_hissb_coherence',data=hisscoh
get_data,'da_db_coherence',data=densitycoh
get_data,'bza_bzb_coherence',data=bzcoh


!p.multi = [0,0,3]
;PLOT COHERENCE FOR SELECT FREQUENCIES ON JAN 6TH
plot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,9],xtitle='SC separation (RE)',ytitle='Coherence',$
	title='Coherence length of hiss b/t RBSP-A and RBSP-B!C3.33min waves',yrange=[0.4,1]
plot,1000.*sep.y[goo]/6370.,bzcoh.y[goo,9],xtitle='SC separation (RE)',ytitle='Coherence',$
	title='Coherence length of BzGSE b/t RBSP-A and RBSP-B!C3.33min waves'
plot,1000.*sep.y[goo]/6370.,densitycoh.y[goo,9],xtitle='SC separation (RE)',ytitle='Coherence',$
	title='Coherence length of density b/t RBSP-A and RBSP-B!C3.33min waves'
...
oplot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*ffta.y[goo,9])),psym=0,color=250 ;3.33 min
oplot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*ffta.y[goo,20])),psym=0,color=150 ;1.5 min
...
oplot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*fftb.y[goo,9])),psym=0,color=250 ;3.33 min
oplot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*fftb.y[goo,20])),psym=0,color=150 ;1.5 min
...
;PLOT COHERENCE FOR SELECT FREQUENCIES ON JAN 6TH
plot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,9],xtitle='SC separation (RE)',ytitle='Coherence',$
	title='Coherence length of hiss b/t RBSP-A and RBSP-B for '+strtrim(periods[9],2)+' min period waves',yrange=[0.5,1],xrange=[1.8,3.5],xstyle=1
plot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*ffta.y[goo,9])),xtitle='SC separation (RE)',ytitle='PowerFFT',$
	title='Integrated Hiss power (pT) on RBSP-A for '+strtrim(periods[9],2)+' min period waves',yrange=[1.,100.],/ylog,xrange=[1.8,3.5],xstyle=1
plot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*fftb.y[goo,9])),xtitle='SC separation (RE)',ytitle='PowerFFT',$
	title='IntegratedHiss power (pT) on RBSP-B for '+strtrim(periods[9],2)+' min period waves',yrange=[1.,100.],/ylog,xrange=[1.8,3.5],xstyle=1

!p.multi = [0,0,3]
;PLOT COHERENCE FOR SELECT FREQUENCIES ON JAN 6TH
plot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,2],xtitle='SC separation (RE)',ytitle='Coherence',$
	title='Coherence length of hiss b/t RBSP-A and RBSP-B for '+strtrim(periods[2],2)+' min period waves'
plot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*ffta.y[goo,2])),xtitle='SC separation (RE)',ytitle='PowerFFT',$
	title='Integrated Hiss power (pT) on RBSP-A for '+strtrim(periods[2],2)+' min period waves',yrange=[1.,100.],/ylog
plot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*fftb.y[goo,2])),xtitle='SC separation (RE)',ytitle='PowerFFT',$
	title='IntegratedHiss power (pT) on RBSP-B for '+strtrim(periods[2],2)+' min period waves',yrange=[1.,100.],/ylog

!p.multi = [0,0,3]
;PLOT COHERENCE FOR SELECT FREQUENCIES ON JAN 6TH
plot,1000.*sep.y[goo]/6370.,hisscoh.y[goo,20],xtitle='SC separation (RE)',ytitle='Coherence',$
	title='Coherence length of hiss b/t RBSP-A and RBSP-B for '+strtrim(periods[20],2)+' min period waves'
plot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*ffta.y[goo,20])),xtitle='SC separation (RE)',ytitle='PowerFFT',$
	title='Integrated Hiss power (pT) on RBSP-A for '+strtrim(periods[20],2)+' min period waves',yrange=[1.,100.],/ylog
plot,1000.*sep.y[goo]/6370.,sqrt(abs(1000.*fftb.y[goo,20])),xtitle='SC separation (RE)',ytitle='PowerFFT',$
	title='IntegratedHiss power (pT) on RBSP-B for '+strtrim(periods[20],2)+' min period waves',yrange=[1.,100.],/ylog
...
;-----------------------------------------------
;NOW PLOT GEOPHYSICAL CORRELATIONS WITH 2K


;v1 = 'PeakDet_2K_sp_detrend_detrend'
;v2 = 'Bfield_hissinta_sp_detrend_detrend_interp'
;dynamic_cross_spec_tplot,v1,0,v2,0,T1,T2,window,lag,coherence_time,new_name='Precip_hiss'  
;var = 'Precip_hiss_coherence'
...
split_vec,'rbspa_emfisis_l3_1sec_gse_Mag'
;gently detrend
rbsp_detrend,['PeakDet_2K','Bfield_hissinta','densitya','fesa30','2K_avebounce30','rbspa_emfisis_l3_1sec_gse_Mag_z','2K_avebouncetots'],60.*30.

tplot,['PeakDet_2K','Bfield_hissinta','densitya','fesa30','2K_avebounce30','rbspa_emfisis_l3_1sec_gse_Mag_z','2K_avebouncetots'] + '_detrend'

;Return,[[E_FREQUENCE_coordinate],[PHASE_E1_E2],[COHERENCE_E1_E2],[Aver_Pow_E_1],[Aver_Pow_E_2]]
Results1=cross_spec_tplot('PeakDet_2K_detrend',0,'Bfield_hissinta_detrend',0,T1,T2,sub_interval=3,overlap_index=4)
Results2=cross_spec_tplot('PeakDet_2K_detrend',0,'densitya_detrend',0,T1,T2,sub_interval=3,overlap_index=4)
;Results3=cross_spec_tplot('PeakDet_2K_detrend',0,'rbspa_emfisis_l3_1sec_mgse_Mag_sp_detrend_detrend_z_interp',0,T1,T2,sub_interval=3,overlap_index=4)
;Results4=cross_spec_tplot('PeakDet_2K_detrend',0,'rbspa_emfisis_l3_1sec_mgse_Mag_sp_detrend_detrend_x_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results5=cross_spec_tplot('PeakDet_2K_detrend',0,'fesa30_detrend',0,T1,T2,sub_interval=3,overlap_index=4)
;Results6=cross_spec_tplot('PeakDet_2K_detrend',0,'fesa54_sp_detrend_detrend_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results7=cross_spec_tplot('PeakDet_2K_detrend',0,'2K_avebounce30_detrend',0,T1,T2,sub_interval=3,overlap_index=4)
;Results8=cross_spec_tplot('PeakDet_2K_detrend',0,'fesa80_sp_detrend_detrend_interp',0,T1,T2,sub_interval=3,overlap_index=4)
;Results9=cross_spec_tplot('PeakDet_2K_detrend',0,'fesa108_sp_detrend_detrend_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results10=cross_spec_tplot('PeakDet_2K_detrend',0,'rbspa_emfisis_l3_1sec_gse_Mag_z_detrend',0,T1,T2,sub_interval=3,overlap_index=4)


;db_precip = 10.*alog10(results1[*,3]/max(results1[*,3],/nan))
;db_hiss = 10.*alog10(results1[*,4]/max(results1[*,4],/nan))
;db_powerbz = 10.*alog10(results10[*,4]/max(results10[*,4],/nan))
;db_powerdens = 10.*alog10(results2[*,4]/max(results2[*,4],/nan))
;db_powerfesa30 = 10.*alog10(results5[*,4]/max(results5[*,4],/nan))

db_precip = 10.*alog10(results1[*,3]/results1[3,3])
db_hiss = 10.*alog10(results1[*,4]/results1[3,4])
db_bz = 10.*alog10(results10[*,4]/results10[3,4])
db_dens = 10.*alog10(results2[*,4]/results2[3,4])
db_fesa30 = 10.*alog10(results5[*,4]/results5[3,4])
db_bounce = 10.*alog10(results7[*,4]/results7[3,4])

;Normalize by the power at 0.001 Hz
;powerprecip = results1[*,3]/results1[4,3]
;powerhiss = results1[*,4]/results1[4,4]
;powerbz = results10[*,4]/results10[4,4]
;powerdens = results2[*,4]/results2[4,4]
;powerfesa30 = results5[*,4]/results5[4,4]



!p.multi =[0,0,6]
plot,1000.*Results1[*,0],db_precip,xrange=[0,10],yrange=[-30,10],title='dB relative to power at 19min period (1.18mHz)',xtitle='freq mHz',ystyle=1,ytitle='xrays'
plot,1000.*Results1[*,0],db_hiss,xrange=[0,10],yrange=[-30,10],xtitle='freq mHz',ystyle=1,ytitle='hiss'
plot,1000.*Results1[*,0],db_bz,xrange=[0,10],yrange=[-30,10],xtitle='freq mHz',ystyle=1,ytitle='BzGSE'
plot,1000.*Results1[*,0],db_dens,xrange=[0,10],yrange=[-30,10],xtitle='freq mHz',ystyle=1,ytitle='Dens'
plot,1000.*Results1[*,0],db_fesa30,xrange=[0,10],yrange=[-30,10],xtitle='freq mHz',ystyle=1,ytitle='FESA30'
plot,1000.*Results1[*,0],db_bounce,xrange=[0,10],yrange=[-30,10],xtitle='freq mHz',ystyle=1,ytitle='Bounce avg'
