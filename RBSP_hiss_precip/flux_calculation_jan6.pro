...
path = '~/Desktop/Research/RBSP_hiss_precip/mageis_cdfs/'
fn = 'rbspa_rel02_ect-mageis-L3_20140106_v4.0.0.cdf'
cdf2tplot,files=path+fn

get_data,'FEDU',data=dd


;It takes RBSP-A about 15 min to cross the BARREL field of view (~1 RE
;mapped to magnetic equator).
t0 = time_double('2014-01-06/20:50:30')
t = time_double('2014-01-06/20:58')
t1 = time_double('2014-01-06/21:05:30')
...
;; PA=        8.1818182 : counts=        129.02489
;; PA=        24.545455 : counts=        608.26014
;; PA=        40.909091 : counts=        541.90450
;; PA=        57.272727 : counts=        825.75922
;; PA=        73.636364 : counts=        2256.7739
;; PA=        90.000000 : counts=        2354.7040
;; PA=        106.36364 : counts=        2683.7176
;; PA=        122.72727 : counts=        877.36918
;; PA=        139.09091 : counts=        806.40550
;; PA=        155.45455 : counts=        580.61196
;; PA=        171.81818 : counts=        258.04977



;Plot range of MagEIS values vs PA for times t0-t1
;This is consistent with the range Joe Fennell sent me of df = 200-400
;at 3 deg PA
plot,dd.v1,dd.y[goo[0],2,*],/ylog,yrange=[100,10000]
