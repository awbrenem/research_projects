...
;for the Jan 3rd RBSP-A hiss/density/precip event
...
t1 = time_double('2014-01-03/21:01')

;;zoomed-out
;t0 = time_double('2014-01-03/19:30')
;t1 = time_double('2014-01-03/22:50')
...
;Smooth values
rbsp_detrend,['rbspa_fbk2_7pk_4','rbspa_fbk2_7pk_3','PeakDet_2I'],60.*0.05


tinterpol_mxn,'rbspa_fbk2_7pk_3_smoothed','PeakDet_2I_smoothed',newname='rbspa_fbk2_7pk_3_smoothed2'
tinterpol_mxn,'rbspa_fbk2_7pk_4_smoothed','PeakDet_2I_smoothed',newname='rbspa_fbk2_7pk_4_smoothed2'
...
dat = tsample('PeakDet_2I_smoothed',[t0,t1],times=t)
store_data,'PeakDet_2I_smoothed2',data={x:t,y:dat}

tplot,['rbspa_fbk2_7pk_4_smoothed2','rbspa_fbk2_7pk_3_smoothed2','PeakDet_2I_smoothed2']


get_data,'PeakDet_2I_smoothed2',data=pk
...
store_data,'pk2I',data={x:pk.x,y:pk.y/max(pk.y,/nan)}
store_data,'fbk',data={x:fbk.x,y:fbk.y/max(fbk.y,/nan)}
store_data,'fbk2',data={x:fbk2.x,y:fbk2.y/max(fbk2.y,/nan)}

;rbsp_detrend,['fbk','pk2I'],60.*10.


;Overall plot
tplot,['pk2I','fbk','fbk2','rbspa_state_lshell']
timebar,'2014-01-03/' + ['20:29','20:42','20:55','21:04','21:38'],varname='pk2I',thick=2,color=50
timebar,'2014-01-03/' + ['20:26','20:38','20:53','21:07','21:40'],varname='fbk',thick=2,color=50
timebar,'2014-01-03/' + ['20:26','20:38','20:53','21:07','21:40'],varname='fbk2',thick=2,color=50
timebar,'2014-01-03/' + ['20:26','20:53','21:38'],varname='rbspa_state_lshell',thick=2,color=50
...
;tplot,['PeakDet_2I_smoothed2','rbspa_fbk2_7pk_4_smoothed','rbspa_state_lshell']
;timebar,'2014-01-03/' + ['20:38','20:53','21:07','21:40'],varname='rbspa_fbk2_7pk_4_smoothed'
;timebar,'2014-01-03/' + ['20:42','20:55','21:04','21:38'],varname='PeakDet_2I_smoothed2'




get_data,'pk2I',data=pk
...
goo = max(r2,locc2)
max_shift2 = dt*lag2[locc2]


;Let's shift the data by this amount
pkshift = pk.x + max_shift
pkshift2 = pk.x + max_shift2

store_data,'pk2I_shift',data={x:pkshift,y:pk.y}

tplot,['fbk','fbk2','pk2I','pk2I_shift']

store_data,'comb',data=['fbk','pk2I','pk2I_shift']
