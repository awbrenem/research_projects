...
tinterpol_mxn,'Bfield_hissinta','PeakDet_2I'
tinterpol_mxn,'Bfield_hissintb','PeakDet_2I'
tinterpol_mxn,'densitya','PeakDet_2I'
tinterpol_mxn,'rbspa_emfisis_l3_1sec_gse_Mag_z','PeakDet_2I'
;tinterpol_mxn,'rbspa_emfisis_l3_1sec_mgse_Mag_z','PeakDet_2I'
;tinterpol_mxn,'rbspa_emfisis_l3_1sec_mgse_Mag_x','PeakDet_2I'
tinterpol_mxn,'fesa30','PeakDet_2I'
tinterpol_mxn,'fesa54','PeakDet_2I'
tinterpol_mxn,'fesa80','PeakDet_2I'
tinterpol_mxn,'fesa108','PeakDet_2I'
tinterpol_mxn,'2I_avebounce30','PeakDet_2I'
tinterpol_mxn,'2I_avebounce50','PeakDet_2I'
tinterpol_mxn,'2I_avebounce75','PeakDet_2I'
tinterpol_mxn,'2I_avebounce150','PeakDet_2I'
tinterpol_mxn,'2I_avebouncetots','PeakDet_2I'
tinterpol_mxn,'2I_avelocal30','PeakDet_2I'
tinterpol_mxn,'2I_avelocal50','PeakDet_2I'
tinterpol_mxn,'2I_avelocal75','PeakDet_2I'
tinterpol_mxn,'2I_avelocal150','PeakDet_2I'
tinterpol_mxn,'2I_avelocaltots','PeakDet_2I'
...
;Results2=cross_spec_tplot('PeakDet_2I_sp_detrend_detrend',0,'densitya_sp_detrend_detrend_interp',0,T1,T2,sub_interval=3,overlap_index=4)Results3=cross_spec_tplot('PeakDet_2I_sp_detrend_detrend',0,'rbspa_emfisis_l3_1sec_mgse_Mag_sp_detrend_detrend_z_interp',0,T1,T2,sub_interval=3,overlap_index=4)
...
Results1=cross_spec_tplot('PeakDet_2I',0,'Bfield_hissinta_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results2=cross_spec_tplot('PeakDet_2I',0,'densitya_interp',0,T1,T2,sub_interval=3,overlap_index=4)
;Results3=cross_spec_tplot('PeakDet_2I',0,'rbspa_emfisis_l3_1sec_mgse_Mag_z_interp',0,T1,T2,sub_interval=3,overlap_index=4)
;Results4=cross_spec_tplot('PeakDet_2I',0,'rbspa_emfisis_l3_1sec_mgse_Mag_x_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results5=cross_spec_tplot('PeakDet_2I',0,'fesa30_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results6=cross_spec_tplot('PeakDet_2I',0,'fesa54_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results8=cross_spec_tplot('PeakDet_2I',0,'fesa80_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results9=cross_spec_tplot('PeakDet_2I',0,'fesa108_interp',0,T1,T2,sub_interval=3,overlap_index=4)
Results10=cross_spec_tplot('PeakDet_2I',0,'rbspa_emfisis_l3_1sec_gse_Mag_z_interp',0,T1,T2,sub_interval=3,overlap_index=4)
