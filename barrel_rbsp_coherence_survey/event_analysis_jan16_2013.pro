;Analysis of coherence event on Jan 30, 2013 during BARREL campaign 1. 
...
;also see Jan31_2013_event.ppt

  rbsp_efw_init
  timespan,'2013-01-16'
  tplot_options,'title','event_analysis_jan16_2013.pro'
  pre = '1'
...
fn = 'barrel_'+pre+'C_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
fn = 'barrel_'+pre+'D_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
fn = 'barrel_'+pre+'I_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
fn = 'barrel_'+pre+'G_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
fn = 'barrel_'+pre+'O_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
fn = 'barrel_'+pre+'K_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn

;Restore individual coherence spectra
path = args_manual.datapath + args_manual.folder_coh + '/'
fn = 'DI_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DG_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DO_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DK_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'DC_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'IG_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IO_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IK_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IC_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'GO_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GK_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GC_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'KO_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'CO_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'CK_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
pp = '/Users/aaronbreneman/Desktop/Research/RBSP_hiss_precip2_coherence_survey/Analysis_major_events_campaign1/Jan16/'

tplot_restore,filenames=pp+'lanl_sat_1991-080_20130116.tplot'
tplot_restore,filenames=pp+'lanl_sat_1994-084_20130116.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-01A_20130116.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-02A_20130116.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-04A_20130116.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-97A_20130116.tplot'
...
t0tmp = time_double('2013-01-16/00:00')
t1tmp = time_double('2013-01-16/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','coh_allcombos_meanfilter_normalized2_OMNI_press_dyn','fspc_1I_smoothed_detrend','fspc_1G_smoothed_detrend','coh_IG_meanfilter'],/add

;tplot,['omni_Np','omni_elect_density']+'_smoothed_detrend'
tplot,['coh_allcombos_meanfilter_normalized2_OMNI_press_dyn','omni_press_dyn_smoothed','fspc_'+pre+'?_smoothed']
tplot,['coh_allcombos_meanfilter_normalized2_OMNI_press_dyn','omni_press_dyn_smoothed_detrend','fspc_'+pre+'?_smoothed_detrend']
...
plot_dial_payload_location_specific_time,'2013-01-16/13:00'
plot_dial_payload_location_specific_time,'2013-01-16/19:00'
...
rbsp_detrend,'*' + ls + '_avg_flux_sopa_e_?',60.*5.
rbsp_detrend,'*' + ls + '_avg_flux_sopa_e_?_smoothed',60.*80.

ylim,'*' + ls + '_avg_flux_sopa_e_?_smoothed_detrend',0,0
tplot,'*' + ls + '_avg_flux_sopa_e_?_smoothed_detrend'
tplot,['fspc_1D_smoothed_detrend','fspc_1G_smoothed_detrend'],/add


ylim,'*' + ls + '_avg_flux_sopa_e_?_smoothed',-1000,1000
tplot,'*' + ls + '_avg_flux_sopa_e_?_smoothed'
tplot,['fspc_1D_smoothed','fspc_1G_smoothed'],/add
