...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-26'
  tplot_options,'title','event_analysis_jan26_2013.pro'
  pre = '1'
...
fn = 'CT_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
fn = 'GT_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
fn = 'ST_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
t0tmp = time_double('2013-01-26/00:00')
t1tmp = time_double('2013-01-26/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


;tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_1C_smoothed_detrend','fspc_1T_smoothed_detrend','coh_CT_meanfilter'],/add
tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_1S_smoothed_detrend','fspc_1T_smoothed_detrend','coh_ST_meanfilter'],/add
...
plot_dial_payload_location_specific_time,'2013-01-26/00:30'
plot_dial_payload_location_specific_time,'2013-01-26/22:00'
