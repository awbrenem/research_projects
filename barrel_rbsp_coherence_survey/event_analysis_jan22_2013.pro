...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-22'
  tplot_options,'title','event_analysis_jan22_2013.pro'
  pre = '1'
...
fn = 'barrel_'+pre+'R_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
fn = 'barrel_'+pre+'S_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
...
fn = 'CH_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IC_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'CQ_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'CR_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'CS_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'GH_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IG_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GQ_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GR_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GS_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'IH_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'HQ_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'HR_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'HS_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'IQ_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IR_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'IS_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'QR_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'QS_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'RS_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
pp = '/Users/aaronbreneman/Desktop/Research/RBSP_hiss_precip2_coherence_survey/Analysis_major_events_campaign1/Jan22/'

tplot_restore,filenames=pp+'lanl_sat_1991-080_20130122.tplot'
tplot_restore,filenames=pp+'lanl_sat_1994-084_20130122.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-01A_20130122.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-02A_20130122.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-04A_20130122.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-97A_20130122.tplot'
...
t0tmp = time_double('2013-01-21/16:00')
t1tmp = time_double('2013-01-22/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_1H_smoothed_detrend','fspc_1R_smoothed_detrend','coh_HR_meanfilter'],/add


tplot,['1994-084_avg_flux_esp_e_0_smoothed_detrend','*avg_flux_sopa_e_0_smoothed','kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_1H_smoothed_detrend','fspc_1R_smoothed_detrend','coh_HR_meanfilter']

;tplot,['omni_Np','omni_elect_density']+'_smoothed_detrend'
tplot,['omni_press_dyn_smoothed','omni_press_dyn_smoothed']
tplot,['fspc_'+pre+'?_smoothed'],/add

tplot,['omni_press_dyn_smoothed_detrend','omni_press_dyn_smoothed_detrend']
tplot,['fspc_'+pre+'?_smoothed_detrend'],/add
...
plot_dial_payload_location_specific_time,'2013-01-22/00:30'
