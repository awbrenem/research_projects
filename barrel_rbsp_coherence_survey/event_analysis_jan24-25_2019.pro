;Storm event for BARREL/FB/RBSP conjunction on 
;Jan 24-25, 2019
...
t0tmp = time_double('2019-01-24/00:00')
t1tmp = time_double('2019-01-26/24:00')
...
tplot,['OMNI_HRO_1min_proton_density','OMNI_HRO_1min_proton_density_smoothed_detrend']
