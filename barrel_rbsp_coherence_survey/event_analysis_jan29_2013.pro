;Analysis of coherence event on Jan 29, 2013 during BARREL campaign 1. 
;Observed on balloons AHIQTU


;Narrative: 


;also see Jan29_2013_event.ppt

;pro event_analysis_jan29_2013
  rbsp_efw_init
  timespan,'2013-01-29'
  tplot_options,'title','event_analysis_jan29_2013.pro'
  pre = '1'
...
split_vec,'tha_fgl'
rbsp_detrend,['tha_fgl*','tha_vaf_0'],30.*60.
;rbsp_detrend,['tha_fge','tha_fgl']+'_smoothed',80.*60.
tplot,['tha_fgl_detrend','tha_vaf_0']
...
t0tmp = time_double('2013-01-29/00:00')
t1tmp = time_double('2013-01-30/00:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_'+pre+'A'+'_smoothed_detrend','fspc_'+pre+'T'+'_smoothed_detrend','coh_AT_meanfilter'],/add
...
plot_dial_payload_location_specific_time,'2013-01-29/15:00'
plot_dial_payload_location_specific_time,'2013-01-29/16:00'
plot_dial_payload_location_specific_time,'2013-01-29/21:00'
