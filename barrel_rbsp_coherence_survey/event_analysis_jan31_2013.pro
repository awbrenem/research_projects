...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-31'
  tplot_options,'title','event_analysis_jan31_2013.pro'
  pre = '1'
...
t0tmp = time_double('2013-01-30/00:00')
t1tmp = time_double('2013-01-31/00:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp


tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','fspc_'+pre+'T'+'_smoothed_detrend','fspc_'+pre+'V'+'_smoothed_detrend','coh_TV_meanfilter'],/add
...
plot_dial_payload_location_specific_time,'2013-01-31/23:30'
plot_dial_payload_location_specific_time,'2013-01-31/22:30'
plot_dial_payload_location_specific_time,'2013-01-31/21:00'
