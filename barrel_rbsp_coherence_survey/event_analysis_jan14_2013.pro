...
;also see Jan31_2013_event.ppt
  ...
  rbsp_efw_init
  timespan,'2013-01-14'
  tplot_options,'title','event_analysis_jan14_2013.pro'
  pre = '1'
...
fn = 'barrel_'+pre+'J_fspc_fullmission.tplot' & tplot_restore,filenames=path + fn
...
fn = 'DJ_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
fn = 'IJ_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'GO_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GK_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'GJ_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'KO_meanfilter.tplot' & tplot_restore,filenames=path + fn
fn = 'JO_meanfilter.tplot' & tplot_restore,filenames=path + fn

fn = 'JK_meanfilter.tplot' & tplot_restore,filenames=path + fn
...
pp = '/Users/aaronbreneman/Desktop/Research/RBSP_hiss_precip2_coherence_survey/Analysis_major_events_campaign1/Jan14/'

tplot_restore,filenames=pp+'lanl_sat_1991-080_20130114.tplot'
tplot_restore,filenames=pp+'lanl_sat_1994-084_20130114.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-01A_20130114.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-02A_20130114.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-04A_20130114.tplot'
tplot_restore,filenames=pp+'lanl_sat_LANL-97A_20130114.tplot'
...
t0tmp = time_double('2013-01-14/00:00')
t1tmp = time_double('2013-01-14/24:00')
;plot_omni_quantities,/noplot,t0avg=t0tmp,t1avg=t1tmp
plot_omni_quantities,t0avg=t0tmp,t1avg=t1tmp

tplot,['kyoto_ae','coh_allcombos_meanfilter_normalized2','coh_allcombos_meanfilter_normalized2_OMNI_press_dyn','coh_DG_meanfilter','fspc_1D_smoothed_detrend','fspc_1G_smoothed_detrend'],/add
...
plot_dial_payload_location_specific_time,'2013-01-14/14:30'
...
rbsp_detrend,'*1994-084_avg_flux_sopa_e_?_smoothed',60.*80.

ylim,'*1994-084_avg_flux_sopa_e_?_smoothed_detrend',0,0
tplot,'*1994-084_avg_flux_sopa_e_?_smoothed_detrend'
