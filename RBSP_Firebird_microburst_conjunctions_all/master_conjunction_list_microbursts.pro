...
;Microbursts are identified by two methods:
;1) detrending using a boxcar average of some length and identifying spiky elements
;2) Shumko's microburst id code 
...
ub = load_firebird_microburst_list(fbtmp,filename='FU4_microburst_catalog_background=0.5_foreground=0.1_threshold=10.csv')
...
;***************;***************;***************;***************;***************;***************
;;***************;***************;***************;***************;***************;***************
;***************THIS NEEDS TO BE REWRITTEN USING SHUMKO'S UB ID LIST. 
;IT DOESN'T MAKE ANY SENSE TO DO THIS MANUALLY B/C I HAVE TO LOAD SO MUCH FIREBIRD DATA THAT IT
...
for j=0.,nconj-1 do begin
  ...
  fbtmp = fb
  cal = firebird_get_calibration_counts2flux(currday,fbtmp)
