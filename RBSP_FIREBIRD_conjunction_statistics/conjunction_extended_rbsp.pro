...
;****IDL CODE DOESN'T SEEM TO EXIST
	...
	if load_new_data or ndays_load gt 1 then begin
		...
		if missingdata ne 1 then begin
			...
			if ndays_load eq 2 then begin
				...
				copy_data,'rbsp'+probe+'_state_mlat','rbsp'+probe+'_state_mlat1'
				...
				get_data,'rbsp'+probe+'_state_mlat',vx,d & get_data,'rbsp'+probe+'_state_mlat1',v1x,d1
				store_data,'rbsp'+probe+'_state_mlat',[v1x,vx],[d1,d]

				store_data,['rbsp'+probe+'_state_mlt1','rbsp'+probe+'_state_lshell1','rbsp'+probe+'_state_mlat1'],/del
